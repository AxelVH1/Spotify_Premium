...
-----------------
Made by DevoWarr
Made for people who want to gain access to Spotify Premium on DESKTOP (for free)!
-----------------
'@`n
...
Write-Host 'Stopping Spotify Services...'`n
...
Write-Host 'Downloading the latest patch (chrome_elf.zip)...'`n
...
Write-Host 'Patching Spotify Files to Premium...'
...
$ch = Read-Host -Prompt "Optional - Remove AD placeholder and Upgrade to Premium button. (Y/N) "
if ($ch -eq 'y') {
...
Write-Host 'Patching Complete, Launching Spotify...'
